        ...
        <div class="row">
            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                <div class="footer-box">
                    <a href="/">
                        @if (@$footer->logo == NULL)
                            <img class="img-responsive" src="{{asset('Assets/Frontend/img/logo.png')}}" alt="logo" width="64" height="64">
                        @else
                            <img class="img-responsive" src="{{asset('storage/images/logo/' .$footer->logo)}}" alt="logo">
                        @endif
                    </a>
                    <div class="footer-about">
                        <p> {{@$footer->desc}} SMP ISLAM CIPASUNG </p>
                    </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                <div class="footer-box">
                    ...
                    <div class="newsletter-area">
                        <p><i class="fa fa-home" aria-hidden="true"></i>Jalan KH. Runlat No.72, Cipakat, Kec. Singaparna, Kabupaten Tasikmalaya, Jawa Barat 46417</p>
                        <p><i class="fa fa-phone" aria-hidden="true"></i> (0265) 545421</p><br/>
                        <p>Ingin mendapat berita terupdate ?</p>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                <p>&copy; {{date('Y')}} SMP ISLAM CIPASUNG</p>
            </div>
